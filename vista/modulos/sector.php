<div class="content-wrapper">
  ...
  <section class="content-header d-flex justify-content-between">
    ...
    <ol class="breadcrumb ">
      ...
      <li class="active" style="margin-left:7px">Administrar sector</li>
    ...
    <div class="box">
      ...
      <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tabla de Sector</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" placeholder="Sector" aria-label="Categoria" aria-describedby="basic-addon1">
              </div>
