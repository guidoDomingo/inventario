                ...
                <table id="example1" class="table table-bordered table-striped tablas">
                  ...
                  <thead>
                    ...
                    <tbody>
                        ...
                        echo ' <tr>
                                <td>'.($key+1).'</td>
                                <td class="puntero">'.$punteros_lideres["nombre"].' '.$punteros_lideres["apellido"].'</td>
                                <td class="puntero">'.$punteros_lideres["cedula"].'</td>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control input-lg" name="nuevoNombre" placeholder="Ingresar nombre del votante" required>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control input-lg" name="nuevoCiudad" placeholder="Ingresar ciudad del votante" required>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control input-lg" name="nuevoBarrio" placeholder="Ingresar barrio del votante" required>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control input-lg" name="nuevoTelefono" placeholder="Ingresar telefono del votante" required>
